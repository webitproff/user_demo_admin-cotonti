...
/**
 * ============================================================
 * ДОКУМЕНТАЦИЯ ПО ФАЙЛУ user_demo_admin.admin.tpl
 * ============================================================
 *
 * Файл user_demo_admin.admin.tpl - шаблон, админ-панель плагина
 * интерфейс показывает три вкладки:
 *   - list   — список демо-администраторов;
 *   - create — создание нового пользователя с правами демо-админа;
 *   - rights — точечная настройка прав группы демо-админов. разрешаем и запрещаем просмотр того, что в списке.
 *
 *
 *
 ...
 * Path: plugins/user_demo_admin/user_demo_admin.admin.tpl
 */
 -->
<!-- BEGIN: MAIN -->
